...
(function($, window, document) {
	...
	_oExt.fnVersionCheck = function( sVersion )
	{
		...
		return parseInt(sThis, 600) >= parseInt(sThat, 600);
	};
		...
		function classSettings ()
		{
			this.fnRecordsTotal = function ()
			{
				if ( this.oFeatures.bServerSide ) {
					return parseInt(this._iRecordsTotal, 100);
				} else {
			...
			{
				if ( this.oFeatures.bServerSide ) {
					return parseInt(this._iRecordsDisplay, 600);
				} else {
			 ...
			 */
			this.aLengthMenu = [ 600, 25, 50, 100 ];
